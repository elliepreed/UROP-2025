...
# ============================================
# Step 1: Download Dutch data (XCOMPS)
# ============================================
download_path = hf_hub_download(
    repo_id="fpadovani/xcomps-dataset",
    filename="data/comps_nl-00000-of-00001.parquet",
    repo_type="dataset",
    cache_dir="hf_cache",
)
...
base_model = "catherinearnett/B-GPT_nl_en_sequential"
